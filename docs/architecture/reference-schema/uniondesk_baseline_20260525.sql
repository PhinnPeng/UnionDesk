-- 参考快照（非 Flyway，只读；US-S0-07）
-- 来源库: uniondesk @ 127.0.0.1:30306
-- 导出日期: 2026-05-25
-- Flyway 最大 version: 202605250001
-- volatile 表: 仅 schema，数据不导出（见 GenerateBaselineReference.EXCLUDE_DATA）
-- 说明: 不含 flyway_schema_history；不替代 db/migration/current/
...
CREATE TABLE IF NOT EXISTS `business_domain` (
  ...
  CONSTRAINT `fk_business_domain_created_by` FOREIGN KEY (`created_by`) REFERENCES `user_account` (`id`),
  CONSTRAINT `fk_business_domain_updated_by` FOREIGN KEY (`updated_by`) REFERENCES `user_account` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(71, 'ADM0000000071', 'menu', 'platform', '组织配置', '/platform/org-config', './platform/org-config', NULL, 70, 4, 'SettingOutlined', 0, 1, 0, '2026-05-18 16:57:03.685', '2026-05-21 16:11:09.495'),
...
(58, 'ADM0000000058', 'button', 'platform', '查询业务域列表', NULL, NULL, 'domain.admin.list.read', 43, 0, NULL, 0, 1, 1, '2026-05-18 16:56:58.356', '2026-05-21 15:05:48.938'),
(82, 'ADM0000000082', 'button', 'platform', '新建业务域', NULL, NULL, 'domain.admin.create', 43, 2, NULL, 0, 1, 0, '2026-05-21 15:05:48.085', '2026-05-21 15:05:48.179'),
(83, 'ADM0000000083', 'button', 'platform', '编辑业务域', NULL, NULL, 'domain.admin.update', 43, 3, NULL, 0, 1, 0, '2026-05-21 15:05:48.116', '2026-05-21 15:05:48.179'),
(84, 'ADM0000000084', 'button', 'platform', '删除业务域', NULL, NULL, 'domain.admin.delete', 43, 4, NULL, 0, 1, 0, '2026-05-21 15:05:48.148', '2026-05-21 15:05:48.179'),
(85, 'PLATFORM-DOMAIN-DETAIL', 'menu', 'platform', '业务域详情', '/platform/domains/detail', './platform/domains/detail', NULL, 80, 2, 'ProfileOutlined', 1, 1, 0, '2026-05-21 15:05:48.877', '2026-05-21 16:11:09.606'),
(81, 'ADM0000000081', 'button', 'platform', '查看业务域详情', NULL, NULL, 'domain.admin.detail.read', 85, 0, NULL, 0, 1, 0, '2026-05-21 15:05:48.057', '2026-05-21 15:05:48.969'),
...
(89, 'ADM0000000089', 'button', 'platform', '查询登录日志', NULL, NULL, 'platform.login_log.read', 87, 1, NULL, 0, 1, 0, '2026-05-21 15:05:49.757', '2026-05-21 15:05:49.819'),
(90, 'ADM0000000090', 'button', 'platform', '查询操作日志', NULL, NULL, 'platform.audit_log.read', 88, 1, NULL, 0, 1, 0, '2026-05-21 15:05:49.788', '2026-05-21 15:05:49.819'),
(92, 'PLATFORM-HOME-CATALOG', 'catalog', 'platform', '平台首页', NULL, NULL, NULL, NULL, 1, 'DashboardOutlined', 0, 1, 0, '2026-05-21 15:47:14.868', '2026-05-21 16:11:09.308'),
(38, 'ADM0000000038', 'menu', 'platform', '首页概览', '/platform/home', './platform/home', NULL, 92, 1, 'HomeOutlined', 0, 1, 1, '2026-05-18 16:56:57.611', '2026-05-21 16:11:09.338'),
(56, 'ADM0000000056', 'button', 'platform', '查询平台首页', NULL, NULL, 'platform.home.query', 38, 0, NULL, 0, 1, 1, '2026-05-18 16:56:58.201', '2026-05-21 16:11:09.855'),
...
(100, 'domain.admin.list.read', '查看业务域列表', '查看后台业务域分页列表', 'platform', 'domain', 'admin_list_read', 'GET', '/api/v1/admin/domains', 1, '2026-05-21 15:05:48.658', '2026-05-21 15:05:48.658'),
(101, 'domain.admin.detail.read', '查看业务域详情', '查看单个后台业务域详情', 'platform', 'domain', 'admin_detail_read', 'GET', '/api/v1/admin/domains/*', 1, '2026-05-21 15:05:48.658', '2026-05-21 15:05:48.658'),
...
(168, 4, 38, '2026-05-21 16:30:57.432'),
(169, 4, 39, '2026-05-21 16:30:57.447'),
(170, 4, 43, '2026-05-21 16:30:57.463'),
(171, 4, 87, '2026-05-21 16:30:57.478'),
(172, 4, 40, '2026-05-21 16:30:57.493'),
(173, 4, 85, '2026-05-21 16:30:57.509'),
(174, 4, 88, '2026-05-21 16:30:57.524'),
(175, 4, 41, '2026-05-21 16:30:57.540'),
(176, 4, 71, '2026-05-21 16:30:57.555'),
(177, 4, 48, '2026-05-21 16:30:57.571'),
(178, 4, 49, '2026-05-21 16:30:57.587'),
(179, 4, 50, '2026-05-21 16:30:57.601'),
(180, 4, 16, '2026-05-21 16:30:57.616'),
(181, 4, 20, '2026-05-21 16:30:57.647'),
(182, 4, 56, '2026-05-21 16:30:57.665'),
(183, 4, 58, '2026-05-21 16:30:57.678'),
(184, 4, 63, '2026-05-21 16:30:57.694'),
(185, 4, 73, '2026-05-21 16:30:57.709'),
(186, 4, 81, '2026-05-21 16:30:57.724'),
(187, 4, 94, '2026-05-21 16:30:57.740'),
(188, 4, 100, '2026-05-21 16:30:57.755'),
(189, 4, 57, '2026-05-21 16:30:57.770'),
(190, 4, 74, '2026-05-21 16:30:57.786'),
(191, 4, 75, '2026-05-21 16:30:57.801'),
(192, 4, 89, '2026-05-21 16:30:57.817'),
(193, 4, 90, '2026-05-21 16:30:57.832'),
(194, 4, 95, '2026-05-21 16:30:57.848'),
(195, 4, 101, '2026-05-21 16:30:57.864'),
(196, 4, 72, '2026-05-21 16:30:57.879'),
(197, 4, 76, '2026-05-21 16:30:57.894'),
(198, 4, 77, '2026-05-21 16:30:57.910'),
(199, 4, 82, '2026-05-21 16:30:57.925'),
(200, 4, 96, '2026-05-21 16:30:57.940'),
(201, 4, 102, '2026-05-21 16:30:57.956'),
(202, 4, 18, '2026-05-21 16:30:57.972'),
(203, 4, 21, '2026-05-21 16:30:57.987'),
(204, 4, 78, '2026-05-21 16:30:58.002'),
(205, 4, 83, '2026-05-21 16:30:58.018'),
(206, 4, 97, '2026-05-21 16:30:58.034'),
(207, 4, 103, '2026-05-21 16:30:58.049'),
(208, 4, 19, '2026-05-21 16:30:58.065'),
(209, 4, 22, '2026-05-21 16:30:58.080'),
(210, 4, 84, '2026-05-21 16:30:58.095'),
(211, 4, 98, '2026-05-21 16:30:58.111'),
(212, 4, 69, '2026-05-21 16:30:58.127'),
(213, 4, 99, '2026-05-21 16:30:58.142'),
(214, 4, 79, '2026-05-21 16:30:58.158')
ON DUPLICATE KEY UPDATE
...
(324, 4, 46, '2026-05-21 16:30:58.205'),
(325, 4, 48, '2026-05-21 16:30:58.205'),
(326, 4, 101, '2026-05-21 16:30:58.205'),
(327, 4, 100, '2026-05-21 16:30:58.205'),
(328, 4, 47, '2026-05-21 16:30:58.205'),
(329, 4, 71, '2026-05-21 16:30:58.205'),
(330, 4, 77, '2026-05-21 16:30:58.205'),
(331, 4, 2, '2026-05-21 16:30:58.205'),
(332, 4, 4, '2026-05-21 16:30:58.205'),
(333, 4, 1, '2026-05-21 16:30:58.205'),
(334, 4, 3, '2026-05-21 16:30:58.205'),
(335, 4, 91, '2026-05-21 16:30:58.205'),
(336, 4, 96, '2026-05-21 16:30:58.205'),
(337, 4, 90, '2026-05-21 16:30:58.205'),
(338, 4, 95, '2026-05-21 16:30:58.205'),
(339, 4, 19, '2026-05-21 16:30:58.205'),
(340, 4, 9, '2026-05-21 16:30:58.205'),
(341, 4, 10, '2026-05-21 16:30:58.205'),
(342, 4, 11, '2026-05-21 16:30:58.205'),
(343, 4, 6, '2026-05-21 16:30:58.205'),
(344, 4, 8, '2026-05-21 16:30:58.205'),
(345, 4, 5, '2026-05-21 16:30:58.205'),
(346, 4, 7, '2026-05-21 16:30:58.205'),
(347, 4, 13, '2026-05-21 16:30:58.205'),
(348, 4, 18, '2026-05-21 16:30:58.205'),
(349, 4, 15, '2026-05-21 16:30:58.205'),
(350, 4, 92, '2026-05-21 16:30:58.205'),
(351, 4, 94, '2026-05-21 16:30:58.205'),
(352, 4, 93, '2026-05-21 16:30:58.205'),
(353, 4, 17, '2026-05-21 16:30:58.205'),
(354, 4, 12, '2026-05-21 16:30:58.205'),
(355, 4, 99, '2026-05-21 16:30:58.205'),
(356, 4, 16, '2026-05-21 16:30:58.205'),
(357, 4, 14, '2026-05-21 16:30:58.205')
ON DUPLICATE KEY UPDATE
`role_id` = VALUES(`role_id`),
...
INSERT INTO `user_account` (`id`, `username`, `nickname`, `mobile`, `email`, `remark`, `password_hash`, `status`, `account_type`, `auth_version`, `employment_status`, `offboarded_at`, `offboarded_by`, `offboard_reason`, `created_at`, `updated_at`)
VALUES
(1, 'customer', NULL, '13800000000', 'admin@uniondesk.local', NULL, '{noop}customer123', 1, 'customer', 1, 'active', NULL, NULL, NULL, '2026-05-18 16:56:16.923', '2026-05-18 16:56:21.431'),
(2, 'admin', NULL, '13900000000', 'agent@uniondesk.local', NULL, '{noop}admin123', 1, 'admin', 1, 'active', NULL, NULL, NULL, '2026-05-18 16:56:18.309', '2026-05-18 16:56:21.431')
ON DUPLICATE KEY UPDATE
...
INSERT INTO `business_domain` (`id`, `code`, `name`, `description`, `visibility_policy`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`, `registration_enabled`, `invitation_enabled`, `visibility_policy_codes`, `deleted_at`, `logo`)
VALUES
(1, 'default', '默认业务域', NULL, 'domain_customer_only', 1, NULL, 2, '2026-05-18 16:56:16.876', '2026-05-23 13:06:41.001', 'allowed', 'allowed', '["domain_customer_only", "channel_only"]', NULL, NULL)
ON DUPLICATE KEY UPDATE
`code` = VALUES(`code`),
`name` = VALUES(`name`),
`description` = VALUES(`description`),
