...
public final class AdminPermissionCatalog {
    ...
    private static final List<PermissionDefinition> DEFINITIONS = List.of(
            ...
            new PermissionDefinition(PermissionCodes.PLATFORM_AUDIT_LOG_READ, "View platform audit logs", "platform", "GET", "/api/v1/admin/audit-logs"),
            ...
            new PermissionDefinition(PermissionCodes.DOMAIN_ADMIN_DELETE, "Delete business domain", "platform", "DELETE", "/api/v1/admin/domains/*"),
            new PermissionDefinition(PermissionCodes.PLATFORM_DOMAIN_CUSTOMER_READ, "View domain customers", "platform", "GET", "/api/v1/admin/domains/*/customers"),
            new PermissionDefinition(PermissionCodes.PLATFORM_DOMAIN_CUSTOMER_CREATE, "Create domain customer", "platform", "POST", "/api/v1/admin/domains/*/customers/**"),
            new PermissionDefinition(PermissionCodes.PLATFORM_DOMAIN_CUSTOMER_UPDATE, "Update domain customer status", "platform", "PATCH", "/api/v1/admin/domains/*/customers/*/status"),
            ...
            new PermissionDefinition(PermissionCodes.DOMAIN_BLOCKED_WORD_READ, "View blocked words", "domain", "GET", "/api/v1/admin/domains/*/blocked-words"),
            new PermissionDefinition(PermissionCodes.DOMAIN_BLOCKED_WORD_CREATE, "Create blocked word", "domain", "POST", "/api/v1/admin/domains/*/blocked-words"),
            new PermissionDefinition(PermissionCodes.DOMAIN_BLOCKED_WORD_DELETE, "Delete blocked word", "domain", "DELETE", "/api/v1/admin/domains/*/blocked-words/*"),
