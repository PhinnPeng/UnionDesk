...
public final class AdminPermissionCatalog {
    ...
    private static final List<PermissionDefinition> DEFINITIONS = List.of(
            ...
            new PermissionDefinition(PermissionCodes.DOMAIN_HOME_READ, "View business home", "domain", null, null),
            new PermissionDefinition(PermissionCodes.DOMAIN_OVERVIEW_READ, "View domain overview", "domain", null, null),
            new PermissionDefinition(PermissionCodes.DOMAIN_GENERAL_READ, "View domain general settings", "domain", "GET", "/api/v1/admin/domains/*"),
            new PermissionDefinition(PermissionCodes.DOMAIN_GENERAL_UPDATE, "Update domain general settings", "domain", "PUT", "/api/v1/admin/domains/*"),
            ...
            new PermissionDefinition(PermissionCodes.DOMAIN_BLOCKED_WORD_CREATE, "Create domain blocked word", "domain", "POST", "/api/v1/admin/domains/*/blocked-words"),
            new PermissionDefinition(PermissionCodes.DOMAIN_BLOCKED_WORD_DELETE, "Delete domain blocked word", "domain", "DELETE", "/api/v1/admin/domains/*/blocked-words/*"),
            new PermissionDefinition(PermissionCodes.DOMAIN_TICKET_ATTRIBUTE_READ, "View domain ticket attributes", "domain", "GET", "/api/v1/admin/domains/*/ticket-attributes"),
            new PermissionDefinition(PermissionCodes.DOMAIN_TICKET_ATTRIBUTE_CREATE, "Create domain ticket attribute", "domain", "POST", "/api/v1/admin/domains/*/ticket-attributes"),
            new PermissionDefinition(PermissionCodes.DOMAIN_TICKET_ATTRIBUTE_UPDATE, "Update domain ticket attribute", "domain", "PUT", "/api/v1/admin/domains/*/ticket-attributes/*"),
            new PermissionDefinition(PermissionCodes.DOMAIN_TICKET_ATTRIBUTE_DELETE, "Delete domain ticket attribute", "domain", "DELETE", "/api/v1/admin/domains/*/ticket-attributes/*"),
            new PermissionDefinition(PermissionCodes.DOMAIN_TICKET_STATUS_READ, "View domain ticket statuses", "domain", "GET", "/api/v1/admin/domains/*/ticket-statuses"),
            new PermissionDefinition(PermissionCodes.DOMAIN_TICKET_STATUS_CREATE, "Create domain ticket status", "domain", "POST", "/api/v1/admin/domains/*/ticket-statuses"),
            new PermissionDefinition(PermissionCodes.DOMAIN_TICKET_STATUS_UPDATE, "Update domain ticket status", "domain", "PUT", "/api/v1/admin/domains/*/ticket-statuses/*"),
            new PermissionDefinition(PermissionCodes.DOMAIN_TICKET_STATUS_DELETE, "Delete domain ticket status", "domain", "DELETE", "/api/v1/admin/domains/*/ticket-statuses/*"),
            ...
            new PermissionDefinition(PermissionCodes.PLATFORM_ROLE_TEMPLATE_READ, "View role templates", "platform", "GET", "/api/v1/iam/role-templates/**"),
            new PermissionDefinition(PermissionCodes.PLATFORM_ROLE_TEMPLATE_CREATE, "Create role template", "platform", "POST", "/api/v1/iam/role-templates"),
            new PermissionDefinition(PermissionCodes.PLATFORM_ROLE_TEMPLATE_UPDATE, "Update role template", "platform", "PUT", "/api/v1/iam/role-templates/*"),
            new PermissionDefinition(PermissionCodes.PLATFORM_ROLE_TEMPLATE_DELETE, "Delete role template", "platform", "DELETE", "/api/v1/iam/role-templates/*"),
            new PermissionDefinition(PermissionCodes.PLATFORM_ROLE_TEMPLATE_APPLY, "Apply role template to domains", "platform", "POST", "/api/v1/iam/role-templates/*/apply"),
            new PermissionDefinition(PermissionCodes.PLATFORM_ROLE_TEMPLATE_SYNC, "Sync role template", "platform", "POST", "/api/v1/iam/role-templates/*/sync"),
            ...
            new PermissionDefinition(PermissionCodes.PLATFORM_USER_READ, "View platform users", "platform", "GET", "/api/v1/admin/staff"),
            new PermissionDefinition(PermissionCodes.DOMAIN_USER_CREATE, "Create domain user", "domain", "POST", "/api/v1/admin/domains/*/members"),
            new PermissionDefinition(PermissionCodes.DOMAIN_USER_READ, "View domain users", "domain", "GET", "/api/v1/admin/domains/*/members"),
            new PermissionDefinition(PermissionCodes.DOMAIN_USER_UPDATE, "Update domain user", "domain", "PUT", "/api/v1/admin/domains/*/members/*"),
            new PermissionDefinition(PermissionCodes.DOMAIN_USER_REMOVE, "Remove domain user", "domain", "DELETE", "/api/v1/admin/domains/*/members/*"),
            new PermissionDefinition(PermissionCodes.PLATFORM_USER_CREATE, "Create platform user", "platform", "POST", "/api/v1/admin/staff"),
            new PermissionDefinition(PermissionCodes.PLATFORM_USER_IMPORT, "Import platform users", "platform", null, null),
            new PermissionDefinition(PermissionCodes.PLATFORM_USER_UPDATE, "Update platform user", "platform", "PUT", "/api/v1/admin/staff/*"),
            new PermissionDefinition(PermissionCodes.PLATFORM_USER_DISABLE, "Disable platform user", "platform", "POST", "/api/v1/admin/staff/*/offboard"),
            new PermissionDefinition(PermissionCodes.PLATFORM_USER_RESET_PASSWORD, "Reset platform user password", "platform", null, null),
            new PermissionDefinition(PermissionCodes.PLATFORM_USER_RESTORE, "Restore platform user", "platform", "POST", "/api/v1/admin/staff/*/restore"),
            new PermissionDefinition(PermissionCodes.PLATFORM_USER_OFFBOARD_POOL_READ, "View offboard pool", "platform", "GET", "/api/v1/admin/staff"),
            ...
            new PermissionDefinition(
                    ...
                    "Update domain member roles",
                    "platform",
                    "PUT",
                    "/api/v1/admin/domains/*/members/*/roles"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_DOMAIN_CONTROL_MEMBER_UPDATE_STATUS,
                    "Update domain member status",
                    "platform",
                    "PUT",
                    "/api/v1/admin/domains/*/members/*/status"),
            new PermissionDefinition(
            ...
            new PermissionDefinition(
                    ...
                    "/api/v1/admin/domains/*/blocked-words/*"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_DOMAIN_CONTROL_TICKET_TYPE_READ,
                    "View domain ticket types",
                    "platform",
                    "GET",
                    "/api/v1/admin/domains/*/ticket-types"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_DOMAIN_CONTROL_TICKET_TYPE_CREATE,
                    "Create domain ticket type",
                    "platform",
                    "POST",
                    "/api/v1/admin/domains/*/ticket-types/**"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_DOMAIN_CONTROL_TICKET_TYPE_UPDATE,
                    "Update domain ticket type",
                    "platform",
                    "PUT",
                    "/api/v1/admin/domains/*/ticket-types/*"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_DOMAIN_CONTROL_TICKET_TYPE_DELETE,
                    "Delete domain ticket type",
                    "platform",
                    "DELETE",
                    "/api/v1/admin/domains/*/ticket-types/*"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_TICKET_CONFIG_ATTR_READ,
                    "View platform ticket attributes",
                    "platform",
                    "GET",
                    "/api/v1/admin/platform/ticket-attributes"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_TICKET_CONFIG_ATTR_CREATE,
                    "Create platform ticket attribute",
                    "platform",
                    "POST",
                    "/api/v1/admin/platform/ticket-attributes"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_TICKET_CONFIG_ATTR_UPDATE,
                    "Update platform ticket attribute",
                    "platform",
                    "PUT",
                    "/api/v1/admin/platform/ticket-attributes/**"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_TICKET_CONFIG_ATTR_DELETE,
                    "Delete platform ticket attribute",
                    "platform",
                    "DELETE",
                    "/api/v1/admin/platform/ticket-attributes/*"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_TICKET_CONFIG_TYPE_READ,
                    "View platform ticket types",
                    "platform",
                    "GET",
                    "/api/v1/admin/platform/ticket-types"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_TICKET_CONFIG_TYPE_CREATE,
                    "Create platform ticket type",
                    "platform",
                    "POST",
                    "/api/v1/admin/platform/ticket-types"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_TICKET_CONFIG_TYPE_UPDATE,
                    "Update platform ticket type",
                    "platform",
                    "PUT",
                    "/api/v1/admin/platform/ticket-types/**"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_TICKET_CONFIG_TYPE_DELETE,
                    "Delete platform ticket type",
                    "platform",
                    "DELETE",
                    "/api/v1/admin/platform/ticket-types/*"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_TICKET_CONFIG_STATUS_READ,
                    "View platform ticket statuses",
                    "platform",
                    "GET",
                    "/api/v1/platform/ticket-statuses"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_TICKET_CONFIG_STATUS_CREATE,
                    "Create platform ticket status",
                    "platform",
                    "POST",
                    "/api/v1/platform/ticket-statuses"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_TICKET_CONFIG_STATUS_UPDATE,
                    "Update platform ticket status",
                    "platform",
                    "PUT",
                    "/api/v1/platform/ticket-statuses/**"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_TICKET_CONFIG_STATUS_DELETE,
                    "Delete platform ticket status",
                    "platform",
                    "DELETE",
                    "/api/v1/platform/ticket-statuses/*"),
            new PermissionDefinition(
                    ...
                    "platform",
                    "GET",
                    "/api/v1/platform/ticket-team-templates/**"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_TICKET_CONFIG_TEMPLATE_CREATE,
                    "Create team template",
                    "platform",
                    "POST",
                    "/api/v1/platform/ticket-team-templates"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_TICKET_CONFIG_TEMPLATE_UPDATE,
                    "Update team template",
                    "platform",
                    "PUT",
                    "/api/v1/platform/ticket-team-templates/**"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_TICKET_CONFIG_TEMPLATE_DELETE,
                    "Delete team template",
                    "platform",
                    "DELETE",
                    "/api/v1/platform/ticket-team-templates/*"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_DOMAIN_CONTROL_TICKET_ATTRIBUTE_READ,
                    "View domain ticket attributes",
                    "platform",
                    "GET",
                    "/api/v1/admin/domains/*/ticket-attributes"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_DOMAIN_CONTROL_TICKET_ATTRIBUTE_CREATE,
                    "Create domain ticket attribute",
                    "platform",
                    "POST",
                    "/api/v1/admin/domains/*/ticket-attributes/**"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_DOMAIN_CONTROL_TICKET_ATTRIBUTE_UPDATE,
                    "Update domain ticket attribute",
                    "platform",
                    "PUT",
                    "/api/v1/admin/domains/*/ticket-attributes/**"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_DOMAIN_CONTROL_TICKET_ATTRIBUTE_DELETE,
                    "Delete domain ticket attribute",
                    "platform",
                    "DELETE",
                    "/api/v1/admin/domains/*/ticket-attributes/*"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_DOMAIN_CONTROL_TICKET_STATUS_READ,
                    "View domain ticket statuses",
                    "platform",
                    "GET",
                    "/api/v1/admin/domains/*/ticket-statuses"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_DOMAIN_CONTROL_TICKET_STATUS_CREATE,
                    "Create domain ticket status",
                    "platform",
                    "POST",
                    "/api/v1/admin/domains/*/ticket-statuses/**"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_DOMAIN_CONTROL_TICKET_STATUS_UPDATE,
                    "Update domain ticket status",
                    "platform",
                    "PUT",
                    "/api/v1/admin/domains/*/ticket-statuses/*"),
            new PermissionDefinition(
                    PermissionCodes.PLATFORM_DOMAIN_CONTROL_TICKET_STATUS_DELETE,
                    "Delete domain ticket status",
                    "platform",
                    "DELETE",
                    "/api/v1/admin/domains/*/ticket-statuses/*"),
            ...
            new PermissionDefinition(PermissionCodes.DOMAIN_TICKET_CLAIM_RULE_READ, "View claim rules", "domain", "GET", "/api/v1/admin/domains/*/ticket-claim-rules"),
            new PermissionDefinition(PermissionCodes.DOMAIN_TICKET_CLAIM_RULE_CREATE, "Create claim rule", "domain", "POST", "/api/v1/admin/domains/*/ticket-claim-rules"),
            new PermissionDefinition(PermissionCodes.DOMAIN_TICKET_CLAIM_RULE_UPDATE, "Update claim rule", "domain", "PUT", "/api/v1/admin/domains/*/ticket-claim-rules/*"),
            new PermissionDefinition(PermissionCodes.DOMAIN_TICKET_CLAIM_RULE_DELETE, "Delete claim rule", "domain", "DELETE", "/api/v1/admin/domains/*/ticket-claim-rules/*"),
