...
public class FileAttachmentPo {
    ...
    public Long getUploaderSubjectId() {
        return uploaderSubjectId;
    }

    public void setUploaderSubjectId(Long uploaderSubjectId) {
        this.uploaderSubjectId = uploaderSubjectId;
    }
