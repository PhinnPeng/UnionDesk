...
import {
	DOMAIN_BLOCKED_WORD_CREATE,
	DOMAIN_BLOCKED_WORD_DELETE,
	DOMAIN_BLOCKED_WORD_READ,
...
export default function DomainBlockwordsPage() {
	...
	return (
		<BasicContent>
			<AuthGuarded auth={DOMAIN_BLOCKED_WORD_READ} fallback={<Empty description="无权限查看屏蔽词库" />}>
				{!domainId
							...
							<Card
								...
								extra={(
									<Space>
										...
										<AuthGuarded auth={DOMAIN_BLOCKED_WORD_CREATE} fallback={null}>
