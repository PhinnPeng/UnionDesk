...
import { DOMAIN_AUDIT_LOG_READ } from "#src/pages/domain/domain-permissions";
...
export default function DomainAuditLogsPage() {
	...
	return (
		<AuthGuarded auth={DOMAIN_AUDIT_LOG_READ} fallback={<BasicContent><Empty description="无权限查看操作日志" /></BasicContent>}>
			<BasicContent>
				<div className="flex flex-col gap-4">
					...
					<Card bordered={false} title="操作日志列表">
						<Table
							rowKey="id"
							loading={loading}
							columns={columns}
